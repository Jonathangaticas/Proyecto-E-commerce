...
import "./CarruselInstagram.css"

const CarruselDeInstagram = () => {
    return (
        
        <div className='container carrusel_instagram'>
          <h4 className='text-center'>Mira nuestras ofertas e ideas de recetas en nuestro instagram.</h4>
          <div id="carouselExampleFade" className="carousel row slide carousel-fade" data-bs-ride="carousel">
